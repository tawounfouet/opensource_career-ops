...
| **Setup help** | Check [docs/guides/faq.md](docs/guides/faq.md) for common questions, then [docs/getting-started/setup.md](docs/getting-started/setup.md), then ask in [Discord](https://discord.gg/8pRpHETxa4) |
