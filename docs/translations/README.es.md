...
Guia completa en [docs/getting-started/setup.md](docs/getting-started/setup.md).
...
- [SETUP.md](docs/getting-started/setup.md) -- Guia de instalacion
- [CUSTOMIZATION.md](docs/getting-started/customization.md) -- Como personalizar
- [ARCHITECTURE.md](docs/architecture/README.md) -- Como funciona el sistema
