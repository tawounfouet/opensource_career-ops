...
const DEFAULT_PORTALS_PATH = process.env.CAREER_OPS_PORTALS || 'config/portals.yml';
...
const PROVIDERS_DIR = resolve(join(dirname(fileURLToPath(import.meta.url)), '..', '..'), 'providers');
